...
namespace GLTFast.Export {
    ...
    public class HighDefinitionMaterialExport : MaterialExportBase {
        ...
        public override bool ConvertMaterial(UnityEngine.Material uMaterial, out Material material, IGltfWritable gltf, ICodeLogger logger ) {
            ...
            if (StandardMaterialExport.EmbedTextures && uMaterial.HasProperty(k_EmissionColorMap)) {
            ...
            // Normal Map
            //
            if (StandardMaterialExport.EmbedTextures &&
            ...
            if (uMaterial.HasProperty(k_CoatMask) && uMaterial.GetFloat(k_CoatMask) > 0)
            {
                ...
                if (StandardMaterialExport.EmbedTextures && uMaterial.HasProperty(k_CoatMaskMap))
                {
            ...
            var mainTexProperty = (StandardMaterialExport.EmbedTextures && uMaterial.HasProperty(k_BaseColorMap)) ? k_BaseColorMap : MainTexProperty;
        ...
        static bool ExportPbrMetallicRoughness(
            ...
            if (StandardMaterialExport.EmbedTextures && uMaterial.HasProperty(k_BaseColorMap)) {
            ...
            if (StandardMaterialExport.EmbedTextures &&
                uMaterial.IsKeywordEnabled(k_KeywordMaskMap) && uMaterial.HasProperty(k_MaskMap)) {
