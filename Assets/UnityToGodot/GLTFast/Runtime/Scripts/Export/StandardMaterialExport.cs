...
namespace GLTFast.Export
{
    ...
    public class StandardMaterialExport : MaterialExportBase
    {
        ...
        public static bool EmbedTextures = true;
        public override bool ConvertMaterial(UnityEngine.Material uMaterial, out Material material, IGltfWritable gltf, ICodeLogger logger)
        {
            ...
            if (EmbedTextures && uMaterial.IsKeywordEnabled(k_KeywordEmission))
            {
            ...
            var needsMetalRoughTexture =
                isPbrMetallicRoughness && EmbedTextures &&
                (
            ...
            if (EmbedTextures && uMaterial.HasProperty(k_BaseMap))
            {
                mainTexProperty = k_BaseMap;
            }
            else if (EmbedTextures && uMaterial.HasProperty(k_ColorTexture))
            {
            ...
            else if (EmbedTextures && uMaterial.HasProperty(mainTexProperty))
            {
            ...
            if (EmbedTextures && uMaterial.HasProperty(k_OcclusionMap))
            {
            ...
            if (needsMetalRoughTexture && EmbedTextures && material.pbrMetallicRoughness != null)
            {
            ...
            if (EmbedTextures && material.occlusionTexture != null)
            {
        ...
        )
        {
            ...
            if (EmbedTextures && uMaterial.HasProperty(mainTexProperty))
            {
            ...
            if (EmbedTextures && uMaterial.HasProperty(k_MetallicGlossMap))
            {
            ...
            if (EmbedTextures && uMaterial.IsKeywordEnabled(k_KeywordSmoothnessTextureAlbedoChannelA))
            {
