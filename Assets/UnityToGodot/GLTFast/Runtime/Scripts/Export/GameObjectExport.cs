...
namespace GLTFast.Export
{
    ...
    public class GameObjectExport
    {
        ...
        //UTG, false for static meshes, true for skinned
        public static bool AddChildren = false;
        public static GameObject ExportObject = null;
        bool AddGameObject(
            ...
            out int nodeId)
        {
            ...
            uint[] children = null;
            //UTG - exporting children will merge multiple static meshes into the same GLB
            if (childCount > 0 )
            {
                if (AddChildren)
                {
